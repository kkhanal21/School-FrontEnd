;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="ffdde54456a821810c63916924d1b943";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["FBdyIN030ync"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["FBdyIN030ync"].options={"id":"UA-50530436-1","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['FBdyIN030ync'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['FBdyIN030ync'].URLPatterns)){(function(){var options=CloudflareApps.installs['FBdyIN030ync'].options
